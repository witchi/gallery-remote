...
public class UrlMessageDialog extends JDialog implements ActionListener {
	private static final long serialVersionUID = -546012873058655256L;
	...
	public UrlMessageDialog(String message, String url, String urlText, String button1Label, String button2Label) {
		super(GalleryRemote.instance().getMainFrame(), GRI18n.getString(MODULE, "warningTitle"), true);
		...
		getContentPane().add(jIcon,
				new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.NORTH, GridBagConstraints.NONE, new Insets(5, 5, 0, 10), 0, 0));
		getContentPane().add(jMessage,
				new GridBagConstraints(1, 0, 2, 1, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 0, 0, 5), 0, 0));
		if (url != null) {
			getContentPane()
					.add(jURL,
							new GridBagConstraints(1, 1, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 0, 5),
									0, 0));
		}
		getContentPane().add(jDontShow,
				new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 0, 0, 5), 0, 0));
		getContentPane().add(jButtons,
				new GridBagConstraints(2, 2, 1, 2, 0.0, 0.0, GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 0, 5, 5), 0, 0));
