...
public class MainFrame extends JFrame implements ActionListener, ItemListener,
	...
	public void startup() {
		...
		jInspectorDivider.setDividerLocation(GalleryRemote._().properties
				.getIntProperty("inspectorDividerLocation"));
		jAlbumPictureDivider.setDividerLocation(GalleryRemote._().properties
			...
			public void run() {
				...
				Log.log(Log.LEVEL_TRACE,
						currentGallery
								...
								+ " - "
								+ currentGallery.getComm(jStatusBar)
										.isLoggedIn());
					...
					if (sel == -1) {
						...
						Object[] params = {
								...
								GRI18n.getString(MODULE, (selN == 1) ? "oneSel"
										: "manySel"),
								new Integer((int) Album
										.getObjectFileSize(jPicturesList.getSelectedValuesList()) / 1024) };
	...
	public void newAlbum() {
		...
		newAlbum.fetchAlbumProperties(GalleryRemote._().getCore()
				.getMainStatusUpdate());
	...
	private void jbInit() throws Exception {// {{{
		...
		jSortCombo.setSelectedIndex(GalleryRemote._().properties
	...
	private void showPreferencesDialog(String panel) {
		PropertiesFile oldProperties = (PropertiesFile) GalleryRemote._().properties
				.clone();
	...
	public void removeGallery(Gallery g) {
		...
		Gallery.removeFromProperties(GalleryRemote._().properties,
				galleries.getSize());
	}
	...
	private void macOSXRegistration() {
		if (GalleryRemote.IS_MAC_OS_X) {
			try {
				...
				Class[] defArgs = { JFrame.class, String.class, String.class,
						String.class };
