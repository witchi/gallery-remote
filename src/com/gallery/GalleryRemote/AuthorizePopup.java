...
public class AuthorizePopup implements ch.innovation.httpclient.AuthorizationPrompter {
	...
	public static void enable() {
		ch.innovation.httpclient.DefaultAuthHandler.setAuthorizationPrompter(new AuthorizePopup());
	}
	 ...
	 */
	@Override
	public NVPair getUsernamePassword(ch.innovation.httpclient.AuthorizationInfo challenge, boolean forProxy) {
