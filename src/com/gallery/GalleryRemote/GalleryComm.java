...
import ch.innovation.httpclient.AuthorizationInfo;
import ch.innovation.httpclient.Cookie;
import ch.innovation.httpclient.CookieModule;
import ch.innovation.httpclient.CookiePolicyHandler;
...
import ch.innovation.httpclient.RoRequest;
import ch.innovation.httpclient.RoResponse;
...
public abstract class GalleryComm implements PreferenceNames {
	...
	public static GalleryComm getCommInstance(StatusUpdate su, URL url, Gallery g) {
		...
		} catch (ch.innovation.httpclient.ProtocolNotSuppException e) {
			Log.logException(Log.LEVEL_ERROR, MODULE, e);
		}
