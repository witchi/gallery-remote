...
class DefaultModule implements HTTPClientModule {
	...
	public int responsePhase2Handler(Response resp, Request req) throws IOException {
		...
		case 408: // Request Timeout
			...
			Log.write(Log.MODS, "DefM:  Handling " + sts + " " + resp.getReasonLine() + " - " + "resending request");
		...
		case 411: // Length Required
			...
			Log.write(Log.MODS, "DefM:  Handling " + sts + " " + resp.getReasonLine() + " - resending " + "request with 'Content-length: 0'");
