...
class MD5InputStream extends FilterInputStream {
	...
	/**
	 * @param is
	 *           the input stream over which the md5 hash is to be calculated
	 * @param verifier
	 *           the HashVerifier to invoke when the stream is closed
	 */
	 ...
	 *               if the close()'ing the underlying stream throws an
