...
public class Util {
	...
	static {
		 ...
		 * awfully long time and is often not needed
		 * 
		 * http_format = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss 'GMT'",
		 * Locale.US); http_format.setTimeZone(new SimpleTimeZone(0, "GMT"));
		 */
	}
	 ...
	 * @see ch.innovation.httpclient.HttpHeaderElement
	 */
	 ...
	 * @see ch.innovation.httpclient.URI#defaultPort(java.lang.String)
	 */
	@Deprecated
