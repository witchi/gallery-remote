...
public class ExifImageUtils {
	...
	public static Date getCreationDate(Directory exifDirectory, Directory iptcDirectory, String filename) {
		...
		if (exifDateCreated == null) {
			Log.log(Log.LEVEL_TRACE, MODULE, "Picture " + filename + " has no EXIF Date Created");
			return null;
		}

		Log.log(Log.LEVEL_TRACE, MODULE, "Picture " + filename + " has EXIF Date Created of " + exifDateCreated);
		try {
