...
public class CropGlassPanePresenterImpl implements CropGlassPanePresenter, MouseListener, MouseMotionListener, ActionListener {

	private final Logger LOGGER = Logger.getLogger(CropGlassPanePresenterImpl.class);
	private final CropGlassPaneModel model;
	private final CropGlassPane view;

	private int movingEdge = 0; // use CropGlassConstants

	public CropGlassPanePresenterImpl(CropGlassPaneModel model, CropGlassPane view) {
	...
	public void mousePressed(MouseEvent e) {
		...
		model.startDragging(movingEdge, e.getPoint());
		mouseDragged(e);

		CropGlassDTO dto = new CropGlassDTO();

		// TODO: add some values to the DTO
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (System.currentTimeMillis() - model.getDragStartTime() < 500) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals(CropGlassPaneActions.REFRESH)) {
			CropGlassDTO dto = new CropGlassDTO();
			// TODO: set values of the dto
			view.refreshUI(dto);
		}
	}
