...
/**
 * This class will escape characters that have an HTML entity representation. It
 * will not escape standard ASCII characters unless it is necessary (i.e. will
 * not escape ASCI #32 but will escape "&amp;"). Any characters with no
 * corresponding entity are passed through unchanged. It uses a quick string ->
 * array mapping to avoid creating thousands of temporary objects.
 */
public class HTMLEscaper {
	...
	public static void main(String[] args) {
		...
		String text = "This is a test of the html escaper & let's hope it really, "
	...
	/**
	 * This method will take the input and escape characters that have an HTML
	 * entity representation. It uses a quick string -> array mapping to avoid
	 * creating thousands of temporary objects.
	 * 
	 * @param nonHTMLsrc
	...
	{ "\u0083", "#131" }, { "\u0084", "#132" }, { "\u0085", "#133" }, { "\u0086", "#134" }, { "\u0087", "#135" }, { "\u0089", "#137" },
			...
			{ "\u00F0", "eth" }, { "\u00F1", "ntilde" }, { "\u00F2", "ograve" }, { "\u00F3", "oacute" }, { "\u00F4", "ocirc" },
			{ "\u00F5", "otilde" }, { "\u00F6", "ouml" }, { "\u00F7", "divid" }, { "\u00F8", "oslash" }, { "\u00F9", "ugrave" },
			{ "\u00FA", "uacute" }, { "\u00FB", "ucirc" }, { "\u00FC", "uuml" }, { "\u00FD", "yacute" }, { "\u00FE", "thorn" },
			{ "\u00FF", "yuml" }, { "\u0080", "euro" } };

	private static String entityMap;
	private static String[] quickEntities;
	private static HashMap<String, String> quickRevEntities = new HashMap<String, String>(ENTITIES.length);
